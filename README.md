...
本项目是一个本地/私有部署的 AI 伙伴聊天应用。当前版本实现了 v6 验证目标：一个频道里两个真人和一个默认沉默的共享 AI，通过 AI 在场/缺席对照与 metrics 读数验证 AI 是否起到“催化剂”作用。
...
- 指标面板：`/metrics/compare` 对比 AI 在场和缺席时的人↔人、人↔AI 换手情况。
